...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private void launchSoundIntent() {
        ...
        Intent soundIntent = new Intent(CreateStoryActivity.this, SoundRecordActivity.class);

		//Uri filename = getOutputMediaFileUri(MEDIA_TYPE_AUDIO);
        File filename = getOutputMediaFile(MEDIA_TYPE_AUDIO);

        soundIntent.putExtra(SoundRecordActivity.EXTRA_OUTPUT, filename.getPath());
	...
	private void launchCameraIntent() {
        ...
        Uri filename = getOutputMediaFileUri(MEDIA_TYPE_IMAGE);
